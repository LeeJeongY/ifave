			...
			<section>
				<div class="cont_sign">
					...
					<form>
								...
								<table class="oTable1">
									...
									<tbody>
										...
										<tr>
											...
											<td class="o-price"><?=number_format($unit_price)?> 원</td>
										</tr>
										<?}?>
									</tbody>
								</table>
							...
							<div class="payComBox">
								<table class="oTable1">
									...
									<tbody>
										<tr>
											<td class="o-product">
												<span>페이팔 특급 cheakout</span>
											</td>
											<td class="o-price"><?=number_format($pay_amount)?> 원</td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<div class="btn-area">
							<?if($UID!="") {?>
							<a href="../member/mypage.php" class="btn-orange btn-c">마이페이지</a>
							<?} else {?>
							<a href="../member/mypage.php?order_num=<?=$order_num?>" class="btn-orange btn-c">마이페이지</a>
							<?}?>
