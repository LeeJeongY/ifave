...
<link rel="stylesheet" type="text/css" href="/css/common_ko.css" />
	...
	$('.anb').hide();
		$('.m-menu').click(function(){
			$('.anb').slideToggle(100, function(){
				if($(this).is(':hidden')) $('.all_gnb').html('<img src="/images/inc/btn-p-close.png">');
				else $('.all_gnb').html('');
			});
		});
...
<div class="anb">
    <div class="aheader">
		...
		<a href="/en/" class="btn_lang_m">ENG</a>
	</div>
	<div class="ah_ins">
		<ul class="anav">
			<li><a href="/<?=$lng?>/brand/brand.php">BRAND</a></li>
			<li><a href="/<?=$lng?>/goods">PRODUCTS</a></li>
			<li><a href="/board/list.php?_t=notice&lng=ko">NOTICE</a></li>
			<li><a href="/board/list.php?_t=pr&lng=ko">PR</a></li>
			<li><a href="/board/list.php?_t=faq&lng=ko">FAQ</a></li>
		</ul>
	</div>
            ...
            <div class="header">
                <div class="hd_top">
					<div>
						...
						<a href="/en/" class="btn_lang">ENG</a>
					</div>
                </div>
