					...
					<input type="hidden" name="idchk" id="idchk" value="">
						...
						<div class="agreeBox">
							<h4>
								...
								<a href="#n" class="viewTerms">개인정보 처리방침 보기 ></a>
							</h4>
							<ul>
								<li>
								...
								<li>
									<label class="checkbox2 check-left" for="ind-agree-3">
										<span>개인정보의 제 3자 제공의 대한 동의 내용</span>
						...
						<div class="btn-area">
							<a href="javascript:;" id="join_submit" class="btn-c btn-complete">회원가입</a>
						</div>
					</form>
				</div>
			</section>
