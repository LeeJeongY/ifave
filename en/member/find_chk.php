...
$(document).ready(function(){
	...
	$("#send_submit").click(function() {
		...
		var s = confirm("Would you like to send it?")
		if(s == true) {
	...
	<input type="hidden" name="user_name" value="<?=$user_name?>">
		...
		<div id="container">
			...
			?>
					<h2>Find ID</h2>
					<p>
						The following ID was found with the info you have provided.
					</p>
					...
					<div class="findBox">
						<ul>
							...
							(<input type="text" class="itx none" name="join_date" id="join_date" size="10" value="<?=substr($regdate,0,10)?>" readonly> <b>Register</b>)
					...
					<div class="btn-area">
						<a href="find_pw.php" class="btn-c btn-complete">Find Password</a>
			...
			?>
					...
					<div class="btn-area">
						<a href="javascript:;" id="send_submit" class="btn-c btn-complete">Send</a>
						<a href="find_pw.php" class="btn-c btn-cancel ml38">Backward</a>
					</div>
			<?
				}
			} else {
			?>
					...
					<div class="findBox">
						<ul>
							<li style="text-align:center;">No information matches the information you entered.</li>
						</ul>
					</div>
