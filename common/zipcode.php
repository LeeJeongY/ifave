...
?>
	...
	function addr_select(arg1, arg2, arg3){
	  if (document.sform.q.value != "") {
		 <?if($flag=="h") {?>
		  window.opener.document.fm.zipcode.value	= arg1;
		  window.opener.document.fm.addr1.value		= arg2;
		  window.opener.document.fm.addr2.value		= arg3;
		  window.opener.document.fm.addr3.focus();
		 <?} else if($flag=="o") {?>
		 ...
		 <?} else if($flag=="c") {?>
		  window.opener.document.fm.client_zipcode.value	= arg1;
		  window.opener.document.fm.client_addr1.value	= arg2;
		  window.opener.document.fm.client_addr2.value	= arg3;
		  window.opener.document.fm.client_addr3.focus();
		 <?} else {?>
					  ...
					  <div class="row">
							<div class="input-group input-group-sm">
								...
								<span class="input-group-btn">
								  <button type="submit" class="btn btn-info btn-flat"><i class="fa fa-search"></i> 검색</button>
								</span>
							</div>
					  </div>
					</div>
